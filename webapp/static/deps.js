...
goog.addDependency('../../../../js/cloth/physical_piece.js', ['diem.cloth.PhysicalPiece', 'diem.cloth.PhysicalPiece.Constraint'], ['diem.MeshWrapper', 'diem.Physics', 'diem.Pin', 'diem.cloth.GeometryMapper', 'diem.events', 'diem.tools.DragPiece'], false);
...
goog.addDependency('../../../../js/person.js', ['diem.Person'], ['diem.MeshWrapper', 'diem.Physics', 'diem.events'], false);
...
goog.addDependency('../../../../js/scene_container.js', ['diem.SceneContainer'], ['diem.EventHandler', 'diem.Globals', 'diem.Person', 'diem.Physics', 'diem.cloth.PhysicalPiece', 'diem.storage.Storage', 'diem.tools.AddAnchorPoint', 'diem.tools.AddPiece', 'diem.tools.AnchorPoint', 'diem.tools.CameraTool', 'diem.tools.DragPiece', 'diem.tools.MovePiece', 'diem.tools.PersonTool', 'diem.tools.RemoveAnchorPoint', 'diem.tools.SeamTool', 'diem.tools.ToolManager', 'goog.events.KeyCodes'], false);
...
goog.addDependency('../../../../js/tools/move_piece.js', ['diem.tools.MovePiece'], ['diem.tools.Tool', 'goog.events.KeyCodes'], false);
