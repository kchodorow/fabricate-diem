...
goog.addDependency('../../../../js/cloth/anchor.js', ['diem.cloth.Anchor'], ['diem.Fabric', 'diem.Globals', 'diem.MeshWrapper', 'diem.cloth.ControlPoint', 'diem.events', 'diem.events.EventBuilder', 'diem.storage.Anchor', 'diem.tools.AnchorPoint', 'diem.tools.RemoveAnchorPoint'], false);
goog.addDependency('../../../../js/cloth/control_point.js', ['diem.cloth.ControlPoint'], ['diem.events', 'diem.events.EventBuilder', 'diem.tools.AnchorPoint'], false);
...
goog.addDependency('../../../../js/cloth/workboard.js', ['diem.cloth.Workboard'], ['diem.Fabric', 'diem.MeshWrapper', 'diem.cloth.Anchor', 'diem.cloth.ControlPoint', 'diem.cloth.Edge', 'diem.cloth.PhysicalPiece', 'diem.storage.Storage', 'diem.tools.DragPiece'], false);
...
goog.addDependency('../../../../js/events/event_builder.js', ['diem.events.EventBuilder'], ['goog.asserts'], false);
...
goog.addDependency('../../../../js/storage/model.js', ['diem.storage.Anchor', 'diem.storage.Edge', 'diem.storage.Model', 'diem.storage.Piece'], ['goog.crypt.Md5'], false);
goog.addDependency('../../../../js/storage/storage.js', ['diem.storage.Storage'], ['diem.storage.Model', 'goog.asserts', 'goog.net.XhrIo'], false);
